$(document).ready(function () {
    ...
    const traductions = {
        fr: {
            ...
            "home-role": "",
            "home-description":
                "Spécialisé en développement web, je crée des solutions modernes, interactives et performantes adaptées aussi bien aux applications web que aux logiciels métiers.",
            "home-btn-projects": "Voir mes projets",
            "home-btn-contact": "Me contacter",
            "about-title": "À propos de moi",
            "about-subtitle": "Qui suis-je?",
            "about-p1":
                "Je suis un développeur passionné par la création d’applications web modernes, performantes et centrées utilisateur. J’interviens en front-end et back-end pour concevoir des solutions élégantes et efficaces.",
            "about-p2":
                "Mon parcours m’a apporté une expertise en PHP et JavaScript ainsi qu’en HTML, CSS, et jQuery. J’ai aussi de bonnes connaissances en Python et en Java",
            ...
            "skills-ai-title": "CMS (Content Management System)",
            ...
            "footer-copyright": "Mahery Ifaliana RASOLOFOMANANA. Tous droits réservés.",
        ...
        en: {
            ...
            "footer-copyright": "Mahery IFaliana RASOLOFOMANANA. All rights reserved.",
        },
    };
    ...
    function setActiveNav() {
        ...
        const headerHeight = $header.length ? $header.outerHeight() + 10 : 80;
        ...
        $sections.each(function () {
            ...
            // Ligne de référence : top de la fenêtre + header
            const y = scrollPos + headerHeight;

            if (y >= top && y < bottom) {
                $('.nav-links a[href="#' + $sec.attr("id") + '"]').addClass("active");
                found = true;
                return false; // break
            }
        });

        // Si on est tout en bas et qu'aucune section n'a matché, active la dernière
        if (!found && $sections.length) {
            const lastId = $sections.last().attr("id");
            $('.nav-links a[href="#' + lastId + '"]').addClass("active");
        }
    }

    // Appels
    $(window).on("scroll resize", setActiveNav);
    // Important : fait le calcul au chargement
    setActiveNav();
    ...
    // --- Révélation au scroll de la section Hackathon ---
    $(function () {
        const items = document.querySelectorAll('#parcours .timeline-item');
    ...
    // --- Révélation section Experience ---
    $(function () {
        const items = document.querySelectorAll('#experience-professionnelle .experience-card');
